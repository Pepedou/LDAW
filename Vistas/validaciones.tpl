<script>
    ...
    $(document).ready(function() {
        ...
        $('#forma_entidad input[type="text"]').tooltipster({
            trigger: 'custom',
            onlyOne: true,
            position: 'right',
            opacity: 0.7
        ...
        $("#forma_entidad").validate({
            ...
            messages: {
                ...
                telefono: {
                    ...
                    maxlength: "Campo no puede exceder 11 valores"
                },
                ...
                id_Rol: "Campo Necesario",
                id_Despacho: "Campo Necesario",
                cp: {
                    required: "Campo Necesario",
                    number: "Campo Numérico",
                    maxlength: "Campo no puede exceder 5 valores"
                },
                cantidad: {
                    required: "Campo Necesario",
